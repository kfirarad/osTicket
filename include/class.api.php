...
class ApiController {
    ...
    function requireApiKey() {
        ...
        elseif (!$key->isActive() || $key->getIPAddr()!=osTicket::get_client_ip())
    ...
    function getApiKey() {
        ...
        if (!$this->apikey && isset($_SERVER['HTTP_X_API_KEY']) && osTicket::get_client_ip())
            $this->apikey = API::lookupByKey($_SERVER['HTTP_X_API_KEY'], osTicket::get_client_ip());
